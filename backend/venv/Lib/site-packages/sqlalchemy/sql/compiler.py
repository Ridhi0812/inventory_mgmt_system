...
class SQLCompiler(Compiled):
    ...
    def insert_single_values_expr(self) -> Optional[str]:
        ...
        used for insert batching schemas to rewrite the VALUES expression.
    ...
    **kw)`` and returns a select object.   this is used for structural changes
    mostly to accommodate for LIMIT/OFFSET schemas
    ...
    def _compose_select_body(
        ...
        # compilation schemas that are currently being tested.

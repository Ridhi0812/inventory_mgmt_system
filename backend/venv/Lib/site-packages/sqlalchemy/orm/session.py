...
class _ConnectionCallableProto(Protocol):
    ...
    for connection-per-instance schemas (i.e. horizontal sharding) to be used
    as persistence time.
...
class ORMExecuteState(util.MemoizedSlots):
    ...
    def invoke_statement(
        ...
        :class:`_engine.Result` object is returned, such as for schemas that
...
class Session(_SessionClassMethods, EventTarget):
    ...
    def _identity_lookup(
        ...
        :param lazy_loaded_from: an :class:`.InstanceState` that is
         ...
         for sharding schemas where there is a correspondence between an object
